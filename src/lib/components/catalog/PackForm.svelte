    ...
    <div class="space-y-6">
      <div class="p-6 bg-card rounded-lg border border-border space-y-4 shadow-sm">
        ...
        <div class="space-y-1.5">
          ...
          <Input id="name" name="name" placeholder="e.g. Content Writer Suite" bind:value={name} required class="bg-background/50" />
        </div>

        <!-- Description -->
        <div class="space-y-1.5">
          <Label for="description">Description</Label>
          <Textarea id="description" name="description" placeholder="Describe the value proposition of this bundle..." bind:value={description} class="bg-background/50" />
        </div>
